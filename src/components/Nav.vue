<template>
  <nav>
    <img
      alt="Instagram"
      class="logo" src="https://instagram.com/static/images/web/mobile_nav_type_logo.png/735145cfe0a4.png" srcset=""/>
    <input type="search" class="search-bar" name="" id="" placeholder="Pesquisar" />
    <ul>
      <li>
        <a href=""
          ><svg
      ...
      <li>
        <span class="avatar">
        <img src="http://localhost:8000/imgs/LMgG8oT__400x400.jpg" alt="">
        </span>
      </li>
    </ul>
  </nav>
